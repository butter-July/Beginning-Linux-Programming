...
//一些不成功的情况
    ...
    //设置dbm函数需要的datum结构，然后是使用dbm_fetch检索数据，如果没有数据可以获得，就返回先前初始化过的空entry_to_return结果
...
int add_cdc_entry(const cdc_entry entry_to_add) {
    ...
    local_data_datum.dptr=(void *) key_to_add;
    local_data_datum.dsize=sizeof(key_to_add);
